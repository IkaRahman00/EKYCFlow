...
exreq_id = ((Math.random() * 100) as int)
exloan_id = ((Math.random() * 100) as int)
response5 = WS.sendRequest(findTestObject('EKYC Flow/Member Existence Check', [('ex_loan_id') : exloan_id, ('ex_req_id') : exreq_id]))
