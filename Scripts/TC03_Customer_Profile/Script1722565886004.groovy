...
println("**************MEMBER ONBOARDING STARTED**************")
 ...
 println(custloan_id)
 response4 = WS.sendRequest(findTestObject('EKYC Flow/Member Onboarding Status', [('stat_req_id') : statreq_id,('NRIC'): P_NRIC]))
 ...
 custloan_id = (long) Math.floor(Math.random() * 9_000_000_000L) + 1_000_000_000L
 response5 = WS.sendRequest(findTestObject('EKYC Flow/Member Existence Check', [('ex_loan_id') : custloan_id, ('ex_req_id') : exreq_id, ('NRIC'): P_NRIC]))
...
response1 = WS.sendRequest(findTestObject('EKYC Flow/Customer Risk Rating', [('cust_req_id') : custreq_id, ('cust_loan_id') : custloan_id, ('NRIC'): P_NRIC]))
...
response2 = WS.sendRequest(findTestObject('EKYC Flow/Industry Risk Rating', [('ind_loan_id') : custloan_id, ('ind_req_id') : indreq_id, ('NRIC'): P_NRIC]))
...
response3 = WS.sendRequest(findTestObject('EKYC Flow/Company Risk Rating', [('com_loan_id') : custloan_id, ('com_req_id') : comreq_id, ('NRIC'): P_NRIC]))
...
response6 = WS.sendRequest(findTestObject('EKYC Flow/Fully EKYC', [('ekyc_loan_id') : custloan_id, ('ekyc_req_id') : ekycreq_id, ('NRIC'): P_NRIC]))
...
response7 = WS.sendRequest(findTestObject('EKYC Flow/Server Bio', [('ser_loan_id') : custloan_id, ('ser_req_id') : serreq_id, ('NRIC'): P_NRIC]))
...
Loanresponse = WS.sendRequest(findTestObject('EKYC Flow/Loan Onboarding', [('Token') : GlobalVariable.Token, ('loan_id') : custloan_id, ('loan_req_id') : loanreq_id, ('email') : email, ('BRN') : BRN, ('NRIC'): P_NRIC]))
...
println(custloan_id)
CRResponse = WS.sendRequest(findTestObject('EKYC Flow/Loan Acc Creation', [('Token') : GlobalVariable.Token, ('crloan_id') : custloan_id, ('crreq_id') : crreq_id, ('BRN') : BRN, ('NRIC'): P_NRIC]))
